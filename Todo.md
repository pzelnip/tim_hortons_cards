...
- [ ] Fix: Confirm modal has no Escape key handler for accessibility (app.js:277-303)
- [ ] Fix: Clear/undo handler doesn't call `updateSyncIndicator()`, so dirty banner won't show (app.js:503-519)
